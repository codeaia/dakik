...
export default class TaskFrame extends Component {
  ...
  render() {
    ...
    disabled = {
      this.props.currentUser.profile.playing || this.props.currentUser.profile.elapsedTime > 0 ? true : false
    }
    onTouchTap = {
      this.deleteTask
    }
    ...
    disabled = {
      this.props.currentUser.profile.playing || this.props.task.checked || this.props.currentUser.profile.elapsedTime > 0 ? true : false
    }
    onTouchTap = {
      this.startPomo
    }
